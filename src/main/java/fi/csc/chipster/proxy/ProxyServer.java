 ...
 * 
 * This is a generic implementation of the actual proxy, but offers only a Java API for configuring
 * and managing the proxy. See ExampleProxyServer how to use it in practice.
 * 
 * @author klemela
 *
 */
